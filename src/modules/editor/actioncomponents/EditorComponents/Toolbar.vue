<template>
  <div id="toolbar" ref="toolbar" class="ql-toolbar ql-snow">
    ...
    ><span class="ql-formats"
      ><button type="button" class="ql-direction" value="rtl">
        <svg viewBox="0 0 18 18">
          ...
          <rect class="ql-fill" height="11" width="1" x="13" y="4"></rect></svg
        ><svg viewBox="0 0 18 18">
          <polygon
            class="ql-stroke ql-fill"
    ...
    ><span class="ql-formats"
      ...
      ><select class="ql-size" style="display: none">
        ...
        <option value="huge"></option></select></span
    ><span class="ql-formats"
    ...
    ><span class="ql-formats"
      ...
      ><select class="ql-background" style="display: none">
        ...
        <option value="#003700"></option>
        <option value="#002966"></option>
        <option value="#3d1466"></option></select></span
    ><span class="ql-formats"
      ...
      ><select class="ql-font" style="display: none">
        ...
        <option value="monospace"></option></select></span
    ><span class="ql-formats"
      ...
      ><select class="ql-align" style="display: none">
        ...
        <option value="justify"></option></select></span
    ><span class="ql-formats"
...
export default {
  ...
  emits: ["toolbarRef"],
  mounted() {
    console.log("this is refs toolbar in toolbar", this.$refs);
    this.$emit("toolbarRef", this.$refs);
    console.log("this is prob executed");
  },
};
</script>
